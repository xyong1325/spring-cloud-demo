...
public class POIUtil {
     ...
     *            查询出的字段list
     */
    public static <T, S> SXSSFWorkbook export(String sheelName, List<T> list,  List<String> fieldNames){
     ...
     * @param fileName 文件名
     */
    public static void writeToResponse(SXSSFWorkbook workbook, HttpServletRequest request,  HttpServletResponse response, String fileName) {
        try  {
